...
export function TrainDefault({ isSick, color }: ITrainProps) {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        stroke={defaultStroke}
      />
      <circle cx="14.6504" cy="31.4968" r="3" fill={defaultStroke} stroke={defaultStroke} />
      <circle cx="44.3413" cy="31.3148" r="3" fill={defaultStroke} stroke={defaultStroke} />
      <circle cx="22.8438" cy="31.4968" r="3" fill={defaultStroke} stroke={defaultStroke} />
      <circle cx="52.5347" cy="31.3148" r="3" fill={defaultStroke} stroke={defaultStroke} />
      <rect
        x="21.8215"
        y="31.0127"
        width="2.04443"
      ...
      <rect
        ...
        stroke={defaultStroke}
      />
      <rect x="1.32153" y="9.44128" width="15" height="11" fill={defaultColor} />
      <rect x="1.32153" y="9.44128" width="15" height="11" stroke={defaultStroke} />
      <path
