        ...
        <>
            <div className={styles.bar}>
                ...
                <div className={styles.bar__right_side}>
                    <Button onClick={setStoryIsOpen.bind(null, true)} className={styles.bar__btn} variant="primary">Операции на станции</Button>
                </div>
            </div>
            <OperationListModal state={storyIsOpen} onClose={setStoryIsOpen.bind(null, false)}/>
        </>
    )
}